...
if(lastTreatment.glucose) { var displayBG = sbx.settings.units === 'mmol' ? sbx.roundBGToDisplayFormat(sbx.scaleMgdl(lastTreatment.glucose)) : lastTreatment.glucose; }
...
function init() {
  ...
  function buildTreatmentMessage(lastTreatment, sbx) {
    return (lastTreatment.glucose ? 'BG: ' + displayBG + ' (' + lastTreatment.glucoseType + ')' : '') +
